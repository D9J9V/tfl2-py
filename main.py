...
def read_root():
    ...
    seed = "addict expect explain convince large gaze ketchup palm bless submit secret flavor"
    command = {
    "platform": "switch",
    "name": "turn_on",
    "params": {
    "entity_id": "switch.1gang_switch"
    }
    }
...
def read_item():
    ...
    controller_address = "4FizBsPF7TPjww7fMKN8Akrnkp5cTfZ4Wt1tXdHt4rEbFS3Q"
    sub_owner_address = "4EJNcRxseH4riAE6ae3B2MJeeJ6DrijoA77UZGwzqdn3myig"
    url = "ipfs-gateway.multi-agent.io"
    port = 443
    encrypt = True
